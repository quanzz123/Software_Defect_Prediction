...
def main():
    ...
    create_notebook('01_Base_Learners.ipynb', 'Huấn Luyện Các Mô Hình Cơ Sở (Base Learners)', base_learners_code, 'report_Base_Learners.csv')
    create_notebook('02_AdaBoost_Ensemble.ipynb', 'Huấn Luyện Các Mô Hình Tích Hợp (AdaBoost Ensembles)', adaboost_code, 'report_AdaBoost.csv')
    create_notebook('03_Bagging_Ensemble.ipynb', 'Huấn Luyện Các Mô Hình Tích Hợp (Bagging Ensembles)', bagging_code, 'report_Bagging.csv')
