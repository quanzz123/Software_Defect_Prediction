...
datasets = [os.path.splitext(os.path.basename(f))[0] for f in arff_files]
...
for ds in datasets:
        ...
        "cells": [
            {
                ...
                "metadata": {},
                "source": [
                    f"# Hyperparameter Tuning for Dataset: {ds}\n",
                    f"Thử nghiệm và tìm kiếm bộ siêu tham số tốt nhất cho các mô hình máy học trên tập dữ liệu `{ds}.arff`."
                ]
            },
            {
                "cell_type": "code",
                ...
                "source": [
                    ...
                    "\n",
                    "# 1. Tải dữ liệu\n",
                    f"dataset_path = '../datasets/{ds}.arff'\n",
            ...
            },
            {
                ...
                "source": [
                    ...
                    f"print(\"\\n\\n==== BÁO CÁO CẤU HÌNH TỐT NHẤT CHO {ds} ====\")\n",
    ...
    output_path = os.path.join(notebooks_dir, f'Tuning_{ds}.ipynb')
    with open(output_path, 'w', encoding='utf-8') as f:
        json.dump(notebook_content, f, ensure_ascii=False, indent=4)
    print(f"Created {output_path}")

print("Successfully generated all tuning notebooks.")
